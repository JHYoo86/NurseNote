...
namespace NurseNote.코드관리
{
    partial class RoomCdMng
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ssList_Sheet1.Columns.Get(1).Width = 176F;
            ...
            this.ssList2_Sheet1.Columns.Get(0).Label = "병실코드";
            ...
            this.ssList2_Sheet1.Columns.Get(1).Label = "명칭";
            this.ssList2_Sheet1.Columns.Get(1).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.ssList2_Sheet1.Columns.Get(1).Width = 133F;
            this.ssList2_Sheet1.Columns.Get(2).CellType = textCellType5;
